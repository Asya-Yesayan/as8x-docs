...
* [appsettings.json](appsettings_json.md) կոնֆիգուրացիոն ֆայլի [Extensions](appsettings_json.md) բաժնում լրացնել առաջացած ընդլայնող dll-ի մասին ինֆորմացիան (անուն, գտնվելու ճանապարհ...)։
