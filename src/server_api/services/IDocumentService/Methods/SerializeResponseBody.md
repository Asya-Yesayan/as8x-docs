...
Այն անհրաժեշտ է կիրառել [AddCustomUIRequest](../../../examples/AddCustomUIRequest.md) մեթոդի կամ [Properties](../../../definitions/document/Properties/Properties.md) հատկության միջոցով փաստաթուղթը 4x ուղարկելիս։
