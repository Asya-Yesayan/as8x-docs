...
Պահպանում է [տեքստային հաշվետվության](../../../Types/TextReport.md) պարունակությունը ֆայլի մեջ։
...
| ----------- | ------------- | --------------- | ----------------------------------------------------------------- |
| storageInfo | StorageInfo   | -               | [Տեքստային հաշվետվությունը](../../../Types/TextReport.md) պարունակող ֆայլի, թղթապանակի անունները։                 |
