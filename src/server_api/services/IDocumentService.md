...
| [Copy(int, object, int)](IAttachmentService/Methods/Copy.md) | Ստեղծում է արդեն գոյություն ունեցող փաստաթղթի պատճեն օբյեկտը։ |
...
| [CreationDate(int, bool)](../definitions/document/Properties/CreationDate.md) | Վերադարձնում է փաստաթղթի ստեղծման ամսաթիվը և ստեղծողի ներքին համարը։ |
...
| [Delete(Document, bool, string, bool, bool)](../../controllers/Document/Methods/Delete.md) | Ջնջում է փաստաթուղթը համակարգից։ |
| [Delete(int, bool, string, bool, bool)](../../controllers/Document/Methods/Delete.md) | Ջնջում է փաստաթուղթը համակարգից։ |
| [DeleteAll(List<int>, bool, string, bool, bool)](../../controllers/Document/Methods/DeleteAll.md) | Ջնջում է տրված փաստաթղթերը համակարգից։ |
...
| [GetParentIsn(int)](IDocumentService/Methods/GetParentIsn.md) | Վերադարձնում է փաստաթղթի միակ(առաջին) ծնող փաստաթղթի ներքին նույնականացման համարը։ |
| [GetParentIsn(int, string)](IDocumentService/Methods/GetParentIsn.md) | Վերադարձնում է փաստաթղթի առաջին ծնող փաստաթղթի ներքին նույնականացման համարը, որը ունի նշված ներքին անունը (տեսակը)։ |
| [GetPassedState(int, List&lt;short&gt;, bool, bool)](IDocumentService/Methods/GetPassedState.md) | Ստուգում է և վերադարձնում փաստաթղթի վերջին կամ առաջին նշանակված վիճակը տրված վիճակների ցուցակից։ |
| [GetPassedState(int, string, bool, bool)](IDocumentService/Methods/GetPassedState.md) | Ստուգում է և վերադարձնում փաստաթղթի վերջին կամ առաջին նշանակված վիճակը վիճակների ցուցակը սահմանող sql հարցում արդյունքից։ |
| [GetPassedState(int, short, bool, bool)](IDocumentService/Methods/GetPassedState.md) | Ստուգում է տրված վիճակը հանդիանում է փաստաթղթի վերջին կամ առաջին նշանակված վիճակը, թե ոչ։ |
| [GetPassedState(int, bool)](IDocumentService/Methods/GetPassedState.md) | Վերադարձնում է փաստաթղթի վերջին կամ առաջին նշանակված վիճակը։ |
...
| [Load(int, GridLoadMode, bool, bool, bool, bool, bool)](../../controllers/Document/Methods/Load.md) | Բեռնում է տվյալների պահոցում գոյություն ունեցող փաստաթուղթը ըստ ներքին նույնականացման համարի։ |
| [Load(int, GridLoadMode, bool, bool, bool, bool, Type, bool)](../../controllers/Document/Methods/Load.md) | Բեռնում է տվյալների պահոցում գոյություն ունեցող փաստաթուղթը ըստ ներքին նույնականացման համարի։ |
| [LoadFromFolder(string, string, GridLoadMode, bool, bool)](IDocumentService/Methods/LoadFromFolder.md) | Բեռնում է փաստաթուղթը ըստ թղթապանակի և բանալու։ |
| [LoadFromFolder(string, string, GridLoadMode, bool, Type, bool)](IDocumentService/Methods/LoadFromFolder.md) | Բեռնում է փաստաթուղթը ըստ թղթապանակի և բանալու։ |
...
| [ReFolder(Document, StoreMode)](DocumentOperationService/Methods/Refolder.md) | Իրականացնում է փաստաթղթի վերաինդեքսավորումը թղթապանակներում: |
...
| [Store(Document, DocumentCheckLevel, string)](../definitions/document/Methods/Store.md) | Անցկացնում է պարտադիր ստուգումներ և գրանցում փաստաթուղթը տվյալների պահոցում։ |
