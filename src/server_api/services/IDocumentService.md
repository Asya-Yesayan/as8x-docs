...
| [CreateFactsUsingStateMoverFrom](IDocumentService/CreateFactsUsingStateMoverFrom.md) | Ֆունկցիան կանչելուց հետո [Action](../definitions/document/Action.md)-ում [StoreFact](IDocumentService/StoreFact.md) ֆունկցիայով գրանցվող հաշվառումների ստեղծող օգատգործող է լրացվում այն օգտագործողը, որը վերջինն է փաստաթուղթը բերել նշված վիճակ։ |
...
| [DeleteAll](IDocumentService/DeleteAll.md) | Ջնջում է տրված փաստաթղթերը համակարգից։ |
