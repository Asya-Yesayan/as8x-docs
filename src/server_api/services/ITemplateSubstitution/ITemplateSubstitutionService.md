...
Տե՛ս նաև [TemplateService](../TemplateService/TemplateService.md) տպելու ձևանմուշների հետ աշխատանքի համար։

Տե՛ս [օրինակը](../Examples/ITemplateSubstitutionService/ITemplateSubstitutionService.md)։
