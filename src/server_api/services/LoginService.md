...
| [CreateDefaultSessionInfo](LoginService/CreateDefaultSessionInfo.md) | Ստեղծում է նոր սեսսիա՝ օգտագործելով տրված պարամետրերը, իսկ սեսսիայի բացակայող դաշտերը (WkDate, ServiceId, ...) լրացնում է լռությամբ արժեքներով։ |
