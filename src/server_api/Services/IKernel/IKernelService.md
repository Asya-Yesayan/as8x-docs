...
| [LastOpDate2(string, int, DateTime?, bool, string, string)](Methods/LastOpDate.md#ikernelservicelastopdate2string-int-datetime-bool-string-string-մեթոդ) | Վերադարձնում է փաստաթղթի հաշվառման վերջին նշանակված գործողության ամսաթիվը, որը ստեղծվել է հաշվառման նշված կոդերով մինչև նշված ամսաթիվը ներառյալ։ |
