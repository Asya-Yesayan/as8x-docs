...
| [AddHeader(string)](IExecutionProgress/AddHeader.md) | Ավելացնում է նոր գլխագիր տող տեքստային հաշվետվության վերին հատվածում։ Առաջադրանքի կատարման ընթացքում մեթոդի կանչի դեպքում տեքստային հաշվետվությունը մնում է անփոփոխ։ |
| [AddFooter(string)](IExecutionProgress/AddFooter.md) | Ավելացնում է նոր տող տեքստային հաշվետվության ստորին հատվածում։ Առաջադրանքի կատարման ընթացքում մեթոդի կանչի դեպքում տեքստային հաշվետվությունը մնում է անփոփոխ։ |
