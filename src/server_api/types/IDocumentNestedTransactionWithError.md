...
|----------|----------------|
| [NestedTransaction(NestedTransactionEventArgs&lt;T&gt;)](IDocumentNestedTransactionWithError/Methods/NestedTransaction.md) | Մեթոդը կանչվում է [IDocumentService](../services/IDocumentService.md)-ի [NestedTransactions](../services/IDocumentService/Methods/NestedTransactions.md) մեթոդի **values** ցուցակի յուրաքանչյուր տարրի մշակման ընթացում: |
