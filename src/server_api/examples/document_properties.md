...
Այս օրինակում`
* [ստեղծվում](../../Bank/Client/Routes/LoanApplicationsRoutes/Methods/Create.md) է **Doc1** տիպի փաստաթուղթ, [արժեքավորվում](../definitions/document/Properties/indexer.md) են որոշ դաշտեր և փաստաթուղթը ավելացվում է ընթացիկ փաստաթղթի [Properties](../definitions/document/Properties/Properties.md)-ում,
