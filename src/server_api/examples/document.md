...
Ստեղծել "TemplGrp" տիպի փաստաթուղթ [DocumentService](../Services/IDocument/IDocumentService.md) դասի [Create](../Services/IDocument/Methods/Create.md) մեթոդով, լրացնել դաշտերի արժեքները ու փաստաթուղթը գրանցել տվյալների պահոցում [DocumentService](../Services/IDocument/IDocumentService.md) դասի [Store](../Services/IDocument/Methods/Store.md) մեթոդով։
