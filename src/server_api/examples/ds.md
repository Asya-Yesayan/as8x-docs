...
2. **Կատարման մեթոդ**
   * Չտիպիզացված՝ [DataSourceService](../Services/DataSource/DataSourceService.md) դասի [ExecuteDataSource](../Services/DataSource/Methods/ExecuteDataSource.md) մեթոդը
   * Տիպիզացված՝ տվյալների աղբյուրի օբյեկտի [Execute](../Definitions/DataSource/Methods/Execute.md) մեթոդը
...
2. Կանչել [DataSourceService](../Services/DataSource/DataSourceService.md) դասի [ExecuteDataSource](../Services/DataSource/Methods/ExecuteDataSource.md) մեթոդը՝ փոխանցելով տվյալների աղբյուրի ներքին անունը և պարամետրերի ցանկը:
...
1. Ստանալ տվյալների աղբյուրի նկարագրող դասը [DataSourceService](../Services/DataSource/DataSourceService.md).[GetDataSource](../Services/DataSource/Methods/GetDataSource.md) մեթոդով:
2. Ստեղծել տվյալների աղբյուրի պարամետրերը նկարագրող դասի օբյեկտ՝ փոխանցելով կատարման համար անհրաժեշտ պարամետրերը։
3. Կանչել տվյալների աղբյուրի դասի [Execute](../Definitions/DataSource/Methods/Execute.md) մեթոդը՝ փոխանցելով պարամետրերը նկարագրող դասը:
