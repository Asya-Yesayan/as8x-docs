...
* Անվանում - Կլիենտի անվանումը (առավելագույնը 50 նիշ)։
* Մանիֆեստ - Json ֆորմատի [Մանիֆեստ](#մանիֆեստ) ֆայլ, որը սահմանում է կլիենտ ծրագրի իրավասությունները և սահմանափակումները։
* Կլիենտի նույնականացման եղանակը՝ սերտիֆիկատով կամ բանալիով։  
...
* Ակտիվ է - Կլիենտը ակտիվ է, թե ոչ։
* Unicode - Կլիենտը հարցումները (Api) կատարելուց օգտագործում է Unicode կոդավորում, թե Ansi կոդավորում:
* Սերվիս - Կլիենտ ծրագրի սերվիս հանդիսանալու հայտանիշ։ Այս նշիչը անհրաժեշտ է միացնել այն կլիենտների համար, որոնք նախատեսված են արտաքին համակարգերից 8x սերվիսին դիմելու համար։
* Անտեսել կրկին մուտք գործելու պարտադրանքը - Նշիչի միացված լինելու դեպքում կլիենտի բոլոր օգտագործողների համար անտեսվում է «Պարտադրել կրկին մուտք գործել համակարգ» պարտադրանքը։
