...
| [Correct(string, object)](Methods/Correct.md) | Եթե սյան արժեքը վալիդ է, ապա այն ձևափոխում է սյան համակարգային տիպին համապատասխան ձևաչափի և վերադարձնում, հակառակ դեպքում վերադարձնում է սկզբնական (չձևափոխված) արժեքը։ |
