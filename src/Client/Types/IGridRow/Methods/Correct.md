...
Եթե սյան արժեքը վալիդ է, ապա այն ձևափոխում (սերիալիզացնում) է սյան համակարգային տիպին համապատասխան ձևաչափի և վերադարձնում, հակառակ դեպքում վերադարձնում է սկզբնական (չձևափոխված) արժեքը։ Օրինակ՝ եթե համակարգային տիպը C(5) է, իսկ արժեքի երկարությունը 3 է, ապա ավելացվում են ևս 2 բացատ։
