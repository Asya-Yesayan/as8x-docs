...
* **Թաբերի միջև անցում կատարելու ժամանակ** — երբ ընթացիկ թաբից անցում է կատարվում աղյուսակ պարունակող թաբի վրա, և անհրաժեշտ է, որ վալիդացիան կրկին աշխատի։
...
**Մեթոդի ընտրությունը**․ Կիրառվում է `EnforceRowsValidation(columns)`, երբ հայտնի է, թե որ սյուների վալիդացիան պետք է վերակատարվի (անհրաժեշտ չէ վերակատարել անփոփոխ սյուների validator-ները, որոնք կարող են ծանր լինել)։ `EnforceAllRowsValidation()` կիրառվում է, երբ զանգվածային փոփոխությունը ազդում է բազմաթիվ սյուների վրա, կամ երբ դժվար է կանխատեսել, թե որ սյուների վալիդացիայի արդյունքները կարող են փոխվել։
