...
| [GetList()](../../server_api/services/IUserService/Methods/GetList.md) | Վերադարձնում է համակարգում առկա բոլոր DPR-ների մետատվյալները (ներքին անուն, հայերեն/անգլերեն անվանումներ, սատարում է չեղարկումը թե ոչ...)։ |
| [GetList(DPRType)](../../server_api/services/IUserService/Methods/GetList.md) | Վերադարձնում է համակարգում առկա նշված `type` տիպի բոլոր DPR-ների մետատվյալները (ներքին անուն, հայերեն/անգլերեն անվանումներ, տեսակ)։ |
| [GetListAsync(CancellationToken)](DataProcessingRequestRoutes/Methods/GetListAsync.md) | Վերադարձնում է համակարգում առկա բոլոր DPR-ների մետատվյալները (ներքին անուն, հայերեն/անգլերեն անվանումներ, տեսակ)։ |
| [GetListAsync(DPRType, CancellationToken)](DataProcessingRequestRoutes/Methods/GetListAsync.md) | Վերադարձնում է համակարգում առկա նշված `type` տիպի բոլոր DPR-ների մետատվյալները (ներքին անուն, հայերեն/անգլերեն անվանումներ, տեսակ)։ |
...
| [GetResult(Guid, bool)](../../server_api/services/IJobServerClient/Methods/GetResult.md) | Վերադարձնում է [Enqueue(DPRType, string, bool, ProcessDPRRequest)](../../server_api/services/IJobServerClient/Methods/Enqueue.md) մեթոդի միջոցով նախապես հերթի դրված [DPR](../../server_api/definitions/dpr.md)-ի կատարման արդյունքը։ |
...
| [GetProgress(Guid)](../../server_api/services/IJobServerClient/Methods/GetProgress.md) | Վերադարձնում է [Enqueue(DPRType, string, bool, ProcessDPRRequest)](../../server_api/services/IJobServerClient/Methods/Enqueue.md) մեթոդի միջոցով նախապես հերթի դրված [DPR](../../server_api/definitions/dpr.md)-ի կատարման պրոգրեսը։ |
...
| [Stop(Guid)](../../server_api/services/IJobServerClient/Methods/Stop.md) | Ընդհատում է նախապես հերթի դրված [DPR](../../server_api/definitions/dpr.md)-ի կատարումը։ |
