...
Այս մեթոդը նախատեսված է դիտելու ձևի նախնական ֆիլտրման դիալոգի ստեղծման և վերադարձման համար։ Ստեղծված դիալոգը անհրաժեշտ է ցուցադրել [ApplyDialog](ApplyDialog.md) մեթոդի միջոցով։
