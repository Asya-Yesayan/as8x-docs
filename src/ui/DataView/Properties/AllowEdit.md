...
Սահմանում է դիտելու ձևի ընթացիկ տողի խմբագրման իրավասությունը` [IsEditEnabled](IsEditEnabled.md) հատկության հետ համատեղ: Հատկության լռությամբ արժեքը false է:
