...
|----------|--------------|----------------|----------------|
| container | LayoutGroup | null | Ծնող դասավորման խումբը։ Եթե **null** է, խումբը ավելացվում է երկխոսության պատուհանի հիմնական դասավորման տարրում։ |
...
Ստեղծված **LayoutGroup** դասավորման խումբը։
