...
|--|--|
| [AddDropDownControl(string, string, IDropDownView, bool, bool, bool, bool, int)](#dialogwindowadddropdowncontrolstring-string-idropdownview-bool-bool-bool-bool-int-մեթոդ) | Երկխոսության պատուհանում ավելացնում է թռուցիկ ընտրացանկով (DropDown) դաշտ։ |
| [AddDropDownControl(LayoutGroup, string, string, IDropDownView, bool, bool, bool, bool, int)](#dialogwindowadddropdowncontrollayoutgroup-string-string-idropdownview-bool-bool-bool-bool-int-մեթոդ) | Նշված դասավորման խմբում ավելացնում է թռուցիկ ընտրացանկով դաշտ։ |
...
Երկխոսության պատուհանում ավելացնում է թռուցիկ ընտրացանկով դաշտ (**DropDownControl**)՝ տրված դիտելու ձևի (**IDropDownView**) հիման վրա։
...
| idv | IDropDownView | — | Թռուցիկ ընտրացանկի դիտելու ձևի (data view) նկարագրությունը։ |
...
Ստեղծված **DropDownControl** դաշտը։
...
Նշված դասավորման խմբում ավելացնում է թռուցիկ ընտրացանկով դաշտ։
