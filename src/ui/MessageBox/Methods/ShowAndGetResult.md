---
title: ShowAndGetResult
parent: "Մեթոդներ"
grand_parent: "MessageBox"
---

# MessageBox.ShowAndGetResult(string, string, MessageBoxButton, MessageBoxImage, MessageBoxResult, Window, int, string, bool) մեթոդ
...
```c#
public static MessageBoxInfoResult ShowAndGetResult(string messageBoxText,
                                                    string caption = null,
...
Ցուցադրում է հաղորդագրության մոդալ պատուհանը և վերադարձնում է օգտագործողի ընտրած կոճակին համապատասխան արդյունքը(**MessageBoxInfoResult**):

Մեթոդն աշխատանքի տրամաբանությամբ համընկնում է [Show](Show.md) մեթոդին և տարբերվում է միայն վերադարձվող արդյունքի կառուցվածքով։ Օգտագործվում է, երբ enableRememberTheAnswer պարամետրով միացվել է **«Կիրառել պատասխանը հաջորդների համար նույնպես»** նշիչը, և անհրաժեշտ է ստանալ նաև նշիչի վիճակը։
...
| icon | MessageBoxImage | MessageBoxImage.None | Պատուհանում ցուցադրվող պատկերակը։ **MessageBoxImage.Hand**, **MessageBoxImage.Question**, **MessageBoxImage.Exclamation** կամ **MessageBoxImage.Asterisk** արժեքների դեպքում ցուցադրման ժամանակ վերարտադրվում է համապատասխան համակարգային ձայնը։ |
