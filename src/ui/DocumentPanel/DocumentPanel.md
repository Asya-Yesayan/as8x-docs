...
DocumentPanel&lt;T&gt; դասը նախատեսված է փաստաթղթի խմբագրման և դիտման ինտերֆեյս կառուցելու համար։ Տրամադրում է փաստաթղթի դաշտերի, աղյուսակերի, թաբների և կոճակների ավելացման հնարավորություն, ինչպես նաև փաստաթղթի կյանքի ցիկլի (բացում, պահպանում, փակում) վրա արձագանքելու վիրտուալ ընդլայնման կետեր։ Դասի **T** ընդհանուր տիպային պարամետրը նշում է վահանակին կցված կոնկրետ փաստաթղթի տիպը՝ ժառանգված **Document** դասից։
