...
Այս դասը նախատեսված է փաստաթղթի նկարագրման համար։
...
| Անվանում | Նկարագրություն |
|----------|----------------|
| [AddButton(string, string, string, string, string, bool, HorizontalAlignment)](Methods/AddButton.md) | Փաստաթղթի վահանակում ավելացնում է կոճակ (**SimpleButton**) և վերադարձնում է այն։ |
...
| [AddDateEditControl(string, string, bool, bool, string, HorizontalAlignment)](Methods/AddDateEditControl.md) | Փաստաթղթի վահանակում ավելացնում է ամսաթվային դաշտ (**DateEditControl**) և վերադարձնում է այն։ |
| [AddDropDownCommentControl(string, string, bool, IDropDownView, short, short, string, short, HorizontalAlignment, StringRestriction)](Methods/AddDropDownCommentControl.md) | Փաստաթղթի վահանակում ավելացնում է մեկնաբանությամբ բացվող ցուցակ (**DropDownCommentControl**) և վերադարձնում է այն։ |
| [AddDropDownControl(string, string, bool, IDropDownView, string, bool, HorizontalAlignment)](Methods/AddDropDownControl.md) | Փաստաթղթի վահանակում ավելացնում է բացվող ցուցակ (**DropDownControl**) և վերադարձնում է այն։ |
...
| [AllowSave()](Methods/AllowSave.md) | Սահմանում է, արդյոք թույլատրված է փաստաթղթի պահպանումը։ |
...
| [OnF3()](Methods/OnF3.md) | Սահմանում է **F3** shortcut-ի սեղմման ժամանակ կատարվող գործողությունը։ |
| [OnF4()](Methods/OnF4.md) | Սահմանում է **F4** shortcut-ի սեղմման ժամանակ կատարվող գործողությունը։ |
| [OnF6()](Methods/OnF6.md) | Սահմանում է **F6** shortcut-ի սեղմման ժամանակ կատարվող գործողությունը։ |
