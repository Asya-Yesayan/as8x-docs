...
null արժեքի դեպքում value պարամետրը չի փոփոխվում և վերադարձվում է (false, դատարկ տող)։
...
Երկու տարրից կազմված արդյունք՝ արժեքի ցուցակում առկայության նշանը և համապատասխան մեկնաբանությունը։ Արժեքը չգտնելու դեպքում վերադարձվում է (false, դատարկ տող)։
