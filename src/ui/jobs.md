...
[«Առաջադրանքների պատմություն»](#առաջադրանքների-պատմություն)/«Առաջադրանքների պատմություն (ըստ քայլերի)» -> «Կատարման ընթացքում առաջացած սխալներ» կոնտեքստային ֆունկցիայի կանչի արդյունքում բացվում է «Հերթագրված առաջադրանքներ (ըստ քայլերի)» դիտելու ձևը, որտեղ ցուցադրվում են առաջադրանքի կատարման քայլերի մանրամասները (կատարման սկիզբ, վերջ, տևողություն, ...)։ Կատարման քայլերի ամբողջական նկարագրությունը ներկայացված է [Առաջադրանքի կատարման քայլեր](#առաջադրանքի-ընթացիկ-քայլի-պարամետրեր) բաժնում։

Նշված դիտելու ձևից հասանելի են [«Արտահանել»](#արտահանել), «Սխալի ամբողջական տեքստը» կոնտեքստային ֆունկցիաները։

![job_execution_details](job_execution_details.png)

## Արտահանել

«Առաջադրանքի կատարման մանրամասներ» -> «Արտահանել» կոնտեքստային ֆունկցիան տալիս է հնարավորություն արտահանել կատարման ընթացքում առաջացած սխալը json ֆորմատով։ Արտահանված լոգերը կարելի է դիտել [Compact Log Viewer](https://www.softpedia.com/get/Programming/Other-Programming-Files/Compact-Log-Viewer.shtml) ծրագրի միջոցով։ «Առաջադրանքի կատարման մանրամասներ» դիտելու ձևը հասանելի է «Ադմինիստրատորի աշտ» -> «Համակարգային աշխատանքներ» -> «Առաջադրանքների պատմություն» դիտելու ձևից՝ «Կատարման ընթացքում առաջացած սխալներ» կոնտքեստային ֆունկցիայով։
...
```json
{
    ...
    "SourceContext": "ArmSoft.AS8X.Core.Job.JobService",
    "UserId": 253
}
```
