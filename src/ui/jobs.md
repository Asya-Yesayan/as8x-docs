...
Նշված դիտելու ձևից հասանելի են [«Արտահանել»](#արտահանել), [«Սխալի ամբողջական տեքստը»](#սխալի-ամբողջական-տեքստը) կոնտեքստային ֆունկցիաները։
...
«Առաջադրանքի կատարման մանրամասներ» դիտելու ձևը հասանելի է «Ադմինիստրատորի աշտ» -> «Համակարգային աշխատանքներ» -> «Առաջադրանքների պատմություն» դիտելու ձևից՝ «Կատարման ընթացքում առաջացած սխալներ» կոնտքեստային ֆունկցիայով։
...
## Սխալի ամբողջական տեքստը

«Առաջադրանքի կատարման մանրամասներ» -> «Սխալի ամբողջական տեքստը» կոնտեքստային ֆունկցիայի կատարման արդյունքում սխալի ամբողջական տեքստը պահպանվում է ֆայլում և ցուցադրվում, որը տեղակայված է տվյալ օգտագործողի համակարգչում՝ ժամանակավոր ֆայլերի թղթապանակում ([Path.GetTempPath](https://learn.microsoft.com/en-us/dotnet/api/system.io.path.gettemppath) թղթապանակի Bank8\JOBERRORS ենթաթղթապանակում): 

Ֆայլի անունը կազմվում է հետևյալ շարահյուսությամբ՝ JobCode_JobStepCode.txt (օրինակ՝ Test_AgrRems_C3_Export.txt): 

«Առաջադրանքի կատարման մանրամասներ» դիտելու ձևը հասանելի է «Ադմինիստրատորի աշտ» -> «Համակարգային աշխատանքներ» -> «Առաջադրանքների պատմություն» դիտելու ձևից՝ «Կատարման ընթացքում առաջացած սխալներ» կոնտքեստային ֆունկցիայով։

![job_error_full_text_function](images/jobs/job_error_full_text_function.png)

![job_error_full_text](images/jobs/job_error_full_text.png)
