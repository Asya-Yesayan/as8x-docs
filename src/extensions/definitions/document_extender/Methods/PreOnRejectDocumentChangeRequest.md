...
Մեթոդը կանչվում է միջուկի կողմից՝ [փաստաթղթի փոփոխման հայտը](../../../../server_api/definitions/document/Properties/DocumentChangeRequest.md)մերժելիս, [OnRejectDocumentChangeRequest](../../../../server_api/definitions/document/Methods/OnRejectDocumentChangeRequest.md) մեթոդի կանչից առաջ։
