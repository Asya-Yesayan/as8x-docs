...
PostMessage մեթոդը կանչվում է միջուկի կողմից` մի փաստաթղթից մյուն ծրագրային հաղորդագրություն([SendMessage](../../../../server_api/definitions/document/Methods/SendMessage.md)) ուղարկելիս՝ [PostMessage](../../../../server_api/definitions/document/Methods/PostMessage.md) մեթոդի կանչից առաջ։
