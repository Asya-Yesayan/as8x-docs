...
Ստեղծված ֆայլերը պետք է [ներմուծել](server_side_module_guide.md) համակարգ, որից հետո [կապակցել](#ընդլայնման-կապակցում-տպելու-ձևանմուշին) տպվող ձևի ձևանմուշին։
...
Պարամետրի հաշվարկը և ավելացումը հնարավոր է կատարել նաև [UserProxyService](../bank/user_proxy_service.md)-ի [TryAddAtomic](../bank/user_proxy_service.md) կամ [TryAddAtomicAsync](../bank/user_proxy_service.md) մեթոդներով։
