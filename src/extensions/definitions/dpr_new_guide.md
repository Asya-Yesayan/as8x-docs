...
Հարկավոր է լրացնել նույն արժեքը ինչ լրացված է C# դասի վրա դրված [DPR ատրիբուտի](../../server_api/types/attributes/DPRAttribute.md) մեջ` [տե՛ս](../../server_api/definitions/dpr.md)։ 
...
### CSSOURCE 
Եթե ընդլայնումը [դինամիկ](../../architecture/extension.md) է, ապա անհրաժեշտ է ավելացնել նաև `CSSOURCE` դաշտը, որը պարունակում է սերվիսային տրամաբանության C# ֆայլի [հարաբերական ճանապարհը](https://phoenixnap.com/kb/absolute-path-vs-relative-path) .as ֆայլի նկատմամբ։
...
.cs ֆայլում հարկավոր է նկարագրել սերվերում աշխատող տրամաբանությունը, տե՛ս Տվյալների մշակման հարցման [C# ֆայլի նկարագրություն](../../server_api/definitions/dpr_guide.md)։
